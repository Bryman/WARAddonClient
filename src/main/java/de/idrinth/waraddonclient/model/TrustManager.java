...
public class TrustManager implements TrustStrategy {
  ...
  public TrustManager(BaseLogger logger)
      throws CertificateException, KeyManagementException, KeyStoreException, IOException,
  ...
  private void getStore()
      throws KeyManagementException, KeyStoreException, IOException, NoSuchAlgorithmException,
  ...
  private void addCertToStore(String name) throws IOException, KeyStoreException {
    ...
    try {
      ...
      try (java.io.BufferedInputStream bis =
          new java.io.BufferedInputStream(resource.openStream())) {
  ...
  static class KeystoreFinder {
    ...
    public java.security.KeyStore getKeystore(String password)
      ...
      store.load(
          new java.io.BufferedInputStream(new java.io.FileInputStream(fileForKeystore())),
    ...
    private java.io.File findStoreFolder() {
      ...
      return new java.io.File(
          file.getAbsolutePath() + fileSeperator + folders[0] + fileSeperator + folders[1]);
    }
  }
}
