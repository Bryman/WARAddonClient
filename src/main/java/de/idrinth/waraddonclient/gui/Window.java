...
public class Window extends JFrame {
  ...
  private void initComponents() {
    ...
    addonListTable.setModel(
        new javax.swing.table.DefaultTableModel(
            new Object[][] {},
            new String[] {"Status", "Name", "Version", "Installed", "Endorsements", "Downloads"}) {
          final Class<Object>[] types =
              new Class[] {
    ...
    buttonDeleteSearch.addMouseListener(
    ...
    buttonUpdateAll.addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                leftSideLayout
                    ...
                    .addGroup(
                        leftSideLayout
                            ...
                            .addComponent(
                                scroll, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                    .addContainerGap()));
        ...
        leftSideLayout
            ...
            .addGroup(
                leftSideLayout
                    ...
                    .addComponent(
                        scroll, javax.swing.GroupLayout.DEFAULT_SIZE, 393, Short.MAX_VALUE)
                    .addContainerGap()));

    base.setLeftComponent(leftSide);

    scrollDescription.setHorizontalScrollBarPolicy(
        ...
        tabMainLayout
            ...
            .addGroup(
                tabMainLayout
                    ...
                    .addGap(42, 42, 42)
                    .addComponent(
                        addonTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
                    .addGap(36, 36, 36)
                            ...
                            .addGroup(
                                tabSettingsLayout
                                    ...
                                    .addComponent(
                                        ...
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(
                                scrollSettings, javax.swing.GroupLayout.Alignment.TRAILING)))
            .addGroup(
                tabSettingsLayout
                    .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(
  ...
  private void installButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_installButtonActionPerformed
    try {
      activeAddon.install();
      updateList();
      ...
      JOptionPane.showMessageDialog(
          this, "Sadly Installing failed, check if the folder is writeable.");
    }
   ...
   * @param evt
   */
  private void inputSearchActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_inputSearchActionPerformed
    newFilter();
   ...
   * @param evt
   */
  private void inputSearchKeyReleased(
      java.awt.event.KeyEvent evt) { // GEN-FIRST:event_inputSearchKeyReleased
    newFilter();
  ...
  private void removeButtonActionPerformed(
    ...
    try {
      ...
      logger.error(exception);
      JOptionPane.showMessageDialog(
          this, "Sadly Removing failed, check if the folder is writeable.");
    }
  } // GEN-LAST:event_removeButtonActionPerformed

  /** @param evt */
  private void uploadEnableActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_uploadEnableActionPerformed
   ...
   * @param evt
   */
  private void menuEnglishActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuEnglishActionPerformed
    changeLanguageTo("en");
  } // GEN-LAST:event_menuEnglishActionPerformed

  /** @param evt */
  private void menuAboutActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuAboutActionPerformed
    javax.swing.JOptionPane.showMessageDialog(
        this,
        "This software is provided for free by Björn Büttner.\n"
            ...
            + "If you need support, go to Guilded:Idrinth's Addons",
        "About",
   ...
   * @param evt
   */
  private void menuDeutschActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuDeutschActionPerformed
    changeLanguageTo("de");
   ...
   * @param evt
   */
  private void menuFrancaisActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuFrancaisActionPerformed
    changeLanguageTo("fr");
  } // GEN-LAST:event_menuFrancaisActionPerformed

  private void buttonDeleteSearchMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_buttonDeleteSearchMouseClicked
    inputSearch.setText("");
  ...
  private void buttonUpdateAllMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_buttonUpdateAllMouseClicked
    int errors = 0;
    int count = 0;
    ...
    if (count == 0) {
      ...
      JOptionPane.showMessageDialog(
          this, "Updating " + errors + " out of " + count + " Add-ons failed.");
    }
  } // GEN-LAST:event_buttonUpdateAllMouseClicked

  private void menuCreateBackupActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuCreateBackupActionPerformed
    try {
      backup.create();
  ...
  private void menuSourceActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuSourceActionPerformed
    try {
  ...
  private void menuBuyMeACoffeeActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuBuyMeACoffeeActionPerformed
    try {
  ...
  private void menuGuildedActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuGuildedActionPerformed
    try {
  ...
  private void menuRestoreBackupActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuRestoreBackupActionPerformed
  ...
  private void menuQuitActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuQuitActionPerformed
    this.dispose();
    Runtime.getRuntime().exit(0);
  } // GEN-LAST:event_menuQuitActionPerformed

  private void menuRestartActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuRestartActionPerformed
    try {
      restarter.restart();
    } catch (IOException ex) {
      logger.error(ex);
  ...
  private void menuWebpageActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_menuWebpageActionPerformed
    try {
  ...
  private class TableListener implements ListSelectionListener {
    ...
    public void updateUi() {
      ...
      if (activeAddon instanceof ActualAddon) {
        new Thread(((ActualAddon) activeAddon).loadDescription(description, config.getLanguage()))
            .start();
      }
