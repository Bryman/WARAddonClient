...
public class IdrinthLookAndFeel extends NimbusLookAndFeel {
  ...
  private void overwriteNimbus() {
    ...
    addColor(
        "ComboBox:\"ComboBox.listRenderer\"[Selected].background", "nimbusSelectionBackground");
    ...
    addColor(
        "List:\"List.cellRenderer\"[Disabled+Selected].background", "nimbusSelectionBackground");
  ...
  private void addColor(
      String uin, String parentUin, float red, float green, float blue, float alpha) {
