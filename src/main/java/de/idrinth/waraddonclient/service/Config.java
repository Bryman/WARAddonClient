...
public class Config {
  ...
  public Config() throws IOException, URISyntaxException {
    ...
    if (getWARPath().equals(".")) {
      ...
      prefs.putInt(
          KEY_WINDOW_HEIGHT, oldPref.getInt(KEY_WINDOW_HEIGHT, getWindowDimension().height));
      prefs.putInt(KEY_WINDOW_WIDTH, oldPref.getInt(KEY_WINDOW_WIDTH, getWindowDimension().width));
      prefs.putInt(
          KEY_WINDOW_LOCATION_X, oldPref.getInt(KEY_WINDOW_LOCATION_X, getWindowPosition().x));
      prefs.putInt(
          KEY_WINDOW_LOCATION_Y, oldPref.getInt(KEY_WINDOW_LOCATION_Y, getWindowPosition().y));
    ...
    version =
        IOUtils.toString(
            Objects.requireNonNull(Config.class.getResourceAsStream("/version")),
  ...
  public Dimension getWindowDimension() {
    return new Dimension(prefs.getInt(KEY_WINDOW_WIDTH, 800), prefs.getInt(KEY_WINDOW_HEIGHT, 450));
  }
  ...
  public Point getWindowPosition() {
    return new Point(
        prefs.getInt(KEY_WINDOW_LOCATION_X, 0), prefs.getInt(KEY_WINDOW_LOCATION_Y, 0));
  }
